    ...
    <div class="row">
        ...
        <div class="smart-box-head">
            <h2 class="light-title title" style="margin-bottom: 0"><img :src="this.gif"
                ...
                style="vertical-align: sub;"> 音乐</span></h2>
            <div class="smart-control pull-right">
                <a class="prev maincolor2 bordercolor2 bgcolor2hover hidden" href="#"
                    ...
                    class="fa fa-angle-right"></i></a> <router-link to="/music/" class="bordercolor2 bgcolor2hover">View all</router-link>
            </div>
        </div>
...
<script>
    export default {
        ...
        created() {
            ...
            this.$axios({
                url: this.$settings.base_url + 'home/show/音乐/',
                method: 'get',
            }).then(response => {
            ...
            this.$axios({
                url: this.$settings.base_url + 'home/gif/music/',
                method: 'get'
            }).then(response => {
                // window.console.log(response);
