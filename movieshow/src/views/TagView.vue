...
<script>
    ...
    export default {
        ...
        created() {
            ...
            let pk = this.$route.query.id;
            this.pk = pk;
            this.$axios({
                url: this.$settings.base_url + 'all/tag/',
                method: 'get',
                params:{
                    pk
            ...
            this.$axios({
                url:this.$settings.base_url + 'all/tag_count/',
                method:'get',
                params:{
                    pk:this.pk
                }
